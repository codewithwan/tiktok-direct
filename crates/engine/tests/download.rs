...
fn fixture_metadata(
    ...
    VideoMetadata {
        ...
        resolved_url: Some("https://www.tiktok.com/@example/video/123".to_string()),
        ...
        author_name: Some("Example".to_string()),
        author_url: None,
        author_unique_id: Some("example".to_string()),
        ...
        webpage_url: Some("https://www.tiktok.com/@example/video/123".to_string()),
        canonical: None,
        thumbnail_url: None,
